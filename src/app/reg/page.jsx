  ...
  return (
    <div className='min-h-screen w-full md: justify-center items-center md:flex gap-10 space-y-10 py-15 bg-[#36ADA330]'>
      <div className="text-center md:p-5 space-y-3">
        ...
        <p className='text-black/70'>Create an account on Out WebSite for gat extra fetcure</p>
      </div>
      <Card className='max-w-110 min-w-100 mx-auto '>
        <h1 className='font-bold text-2xl text-center mb-3'>Create a Account</h1>
        <Form className="flex w-96 flex-col gap-4" onSubmit={onSubmit}>
          ...
          <p className="text-center">Already have an account?<Link href={'/login'} className="font-bold text-[#36ADA3]"> Login</Link> </p>
